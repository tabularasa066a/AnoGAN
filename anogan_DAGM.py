...
def load_imgs(root_dir, class_name):
    ...
    images.reshape(images.shape[0], IMAGE_SIZE, IMAGE_SIZE, 1)
...
if __name__ == '__main__':
    ...
    img_data_Normal = img_data_Normal.reshape(img_data_Normal.shape[0], IMAGE_SIZE, IMAGE_SIZE, 1)  # (1000, 28, 28, 1)
    ...
    img_data_withDefects = img_data_withDefects.reshape(img_data_withDefects.shape[0], IMAGE_SIZE, IMAGE_SIZE, 1)  # (150, 28, 28, 1)
    ...
    for i in range(len(x_test)):
        if y_test[i] == 1 or y_test[i] == 9:  
           x_test_9.append(x_test[i].reshape((IMAGE_SIZE, IMAGE_SIZE, 1))) 
           y.append(y_test[i])
           cnt +=1
        #    if cnt == 100:
        #       break    
